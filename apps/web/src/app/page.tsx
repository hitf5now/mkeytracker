...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Create competitions, sign up with your character, and get automatically matched into balanced teams. Race against rivals.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Leaderboards",
    description:
      "Compete across multiple categories — season points, highest key, most timed runs, and fastest clears per dungeon.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
